...
JPS luo aiemmista algoritmeista poiketen 8 aloitussolmua, joista kullekin se antaa eri suunnan tutkittavaksi ja lisää ne kaikki Kekoon. Esim. aloitussolmu, jonka suuntana on y_suunta = 0, x_suunta = 1 lähtee tutkimaan kartaa x-akselia pitkin oikeaan suuntaan. Niin kauan kuin keko ei ole tyhjä, keosta otetaan f-arvoltaan pienin solmu ja tarkistetaan sen suunta. Suunta-arvoista riippuen poimitusta solmusta alkaen "skannattaan" joko vaaka-, pysty- tai diagonaaliseen suuntaan. Skannausta jatketaan niin kauan kunnes vastaan tulee este tai kartan raja. Matkalta löydetyt jump pointit lisätään kekoon. Diagonaalinen skannaus toimii muuten kuin horisontaalinen ja vertikaalinen, mutta kutakin diagonaalista askelta kohti suoritetaan myös vaaka- ja pystysuora skannaus. Algoritmi jatkaa toimintaansa näin siihen asti kunnes keko on tyhjä tai maali on löytynyt. 
