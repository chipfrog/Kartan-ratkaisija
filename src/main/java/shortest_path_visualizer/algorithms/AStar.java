...
/**
 * Luokka, jossa toteutetaan A* -algoritmi.
 */
public class AStar {
  /**
   ...
   * Tarvitaan NeighbourFinderia varten. Kun solmumatriisin avulla
   * haetaan naapurisolmuja, päästään käsiksi Node-olioihin tallennettuihin tietoihin,
   * kuten eri etäisyyksiin (f ja g), sekä
  ...
  /**
   * Alustaa A*:n tarvitsemat rakenteet, kuten keon ja muuttujat.
  ...
  /**
   * Suorittaa A*-algoritmin. Sijoittaa openListiin aluksi aloitussolmun
   * ja alkaa sitten hakea naapurisolmuja.
   * Naapurit lisätään minimikekoon, josta poimitaan aina solmu,
   * jonka f-etäisyys pienin (f = g-etäisyys + h-etäisyys).
   * Käsitellyt solmut lisätään inClosedListiin ja niihin ei enää kosketa,
   * ellei voida päivittää etäisyyttä paremmaksi.
   * Algoritmin suoritus jatkuu niin kauan, kun openList ei ole tyhjä
   * tai kunnes maalisolmu löytyy.
   */
  ...
  /**
   * Päivittää karttamatriisiin reitin maalisolmusta lähtösolmuun.
   * Katsoo maalisolmusta alkaen, mikä solmu on edeltävän solmun vanhempi jne.
   ...
   * Jos solmut samalla x- tai samalla y-akselilla,
  ...
  /**
   * Alustaa solmumatriisin luoden kustakin char[][] -kartan pisteestä Node-olion.
   * Jos kyseessä todellinen solmu (eikä este '@'), sen
   * g-etäisyydeksi ja heuristiseksi etäisyydeksi asetetaan ääretön.
   * Samalla tallennetaan ylös aloitussolmu ja maalisolmu.
   * Tietoa maalisolmusta tarvitaan, jotta A* osaa suunnata reitinhakua sen suuntaan.
   */
